...
import com.example.a0utperform.ui.main_activity.attendance.detailleaverequest.DetailLeaveRequestViewModel
...
class EditLeaveRequestActivity : AppCompatActivity() {
    ...
    private val viewModel: EditLeaveRequestViewModel by viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnRejectLeave.setOnClickListener {
            viewModel.updateLeaveStatus(leaveRequest.requestId, "Rejected")
        }

        binding.btnApproveLeave.setOnClickListener {
            viewModel.updateLeaveStatus(leaveRequest.requestId, "Approved")
        }

        viewModel.updateStatusResult.observe(this) { success ->
            if (success) {
